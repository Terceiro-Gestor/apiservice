...
<head>
    ...
    <meta content="Sistema de Indicadores da Alvorada" name="description" />
    <meta content="Weverton Campos" name="author" />
    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <a href="index.html" class="logo text-center logo-light">
                <span class="logo-lg">
                    <img src="assets/images/logo_sm_dark.png" alt="" height="48">
                </span>
                <span class="logo-sm">
                    <img src="assets/images/logo_sm_dark.png" alt="" height="48">
                </span>
                ...
                <div class="navbar-custom">
                    <ul class="list-unstyled topbar-menu float-end mb-0">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="../project.php"
                                role="button">
                                <span class="align-middle d-none d-sm-inline-block">Return</span>
                                <i class="mdi mdi-chevron-left d-none d-sm-inline-block align-middle"></i>
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown"
                                ...
                                <span class="account-user-avatar">
                                    <img src="assets/images/logo_sm_dark.png" alt="user-image" class="rounded-circle">
                                </span>
                                <span>
                            ...
                            <div
                                ...
                                <!-- item-->
                                <a href="../project.php" class="dropdown-item notify-item">
